...
func (_m *MockCacheRepository) Set(ctx context.Context, key string, value string, ttl time.Duration) error {
...
func (_c *MockCacheRepository_Set_Call) Run(run func(ctx context.Context, key string, value string, ttl time.Duration)) *MockCacheRepository_Set_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockCacheRepository_Set_Call) RunAndReturn(run func(context.Context, string, string, time.Duration) error) *MockCacheRepository_Set_Call {
	_c.Call.Return(run)
	return _c
}
